...
class ClsFTP{
	var $host = "195.225.58.129";//FTP HOST
	var $port = "21";		//FTP port
	var $user = "realgaming";//FTP user
	var $pass = "realgaming.ro";	//FTP password
	...
	function ClsFTP($user="realgaming",$pass="realgaming.ro",$host="195.225.58.129",$port="21"){
